...
import { SuggestionsPanel } from "@/components/visualizer/SuggestionsPanel";
import { SortingComparison } from "@/components/visualizer/SortingComparison";
import { useToast } from "@/hooks/use-toast";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";

const SORTING_KEYWORDS = ["sort", "bubble", "merge", "quick", "insertion", "heap", "counting", "radix", "selection"];
function isSortingPattern(pattern?: string): boolean {
  if (!pattern) return false;
  const lower = pattern.toLowerCase();
  return SORTING_KEYWORDS.some((kw) => lower.includes(kw));
}
        ...
        <AnimatePresence>
          ...
          {result && !analyzeMutation.isPending && (
            ...
            >
              ...
              {isSortingPattern(result.pattern) && <SortingComparison />}
              ...
              <div className="glass-card rounded-xl border border-white/5 overflow-hidden">
                <Tabs defaultValue="optimal" className="w-full">
                  ...
                  <TabsContent value="optimal" className="p-6">
                    <CodeViewer
                      code={result.code}
                  ...
                  <TabsContent value="bruteforce" className="p-6">
                    {result.brute_force_code ? (
                      ...
                      <div className="text-white/30 text-sm italic">No brute force code available for this result.</div>
                    )}
                  </TabsContent>
                </Tabs>
              </div>
